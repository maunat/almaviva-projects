package it.almaviva.etsi_messages;
...
public class CoopIts {
    ...
    public static enum DriveDirection {
        ...
        public static DriveDirection fromCode(int value) {
            for (DriveDirection element : values()) {
    ...
    public static enum VehicleLengthConfidenceIndication {
        ...
        private VehicleLengthConfidenceIndication(int value) {
            this.value = value;
        }
    ...
    public static enum YawRateConfidence {
        ...
        private YawRateConfidence(int value) {
            this.value = value;
        }
    ...
    public static enum AltitudeConfidence {
        ...
        private AltitudeConfidence(int value) {
            this.value = value;
        }
    ...
    @Sequence
    public static class Cam extends Etsi {
        ItsPduHeader header;
        CoopAwareness cam;
        ...
        public Cam() {
            this(new ItsPduHeader(new ItsPduHeader.MessageId(ItsPduHeader.MessageId.cam)), new CoopAwareness());
        }

        @Override
        public String toString() {
            return "CAM(" + header + ", " + cam + ")";
        }
    ...
    public static class ItsPduHeader {
        ...
        public ItsPduHeader() {
            this(new ProtocolVersion(), new MessageId(), new StationID());
        }
        ...
        public static class ProtocolVersion extends Asn1Integer {
            ...
            public ProtocolVersion(long value) {
                super(value);
            }
        }
    ...
    public static class CamParameters {
        ...
        public CamParameters() {
            this(new BasicContainer(), new HighFrequencyContainer());
        }
    ...
    public static class BasicContainer {
        ...
        public BasicContainer() {
            this(new StationType(), new ReferencePosition());
        }
    ...
    public static class HighFrequencyContainer {
        ...
        public HighFrequencyContainer() {
            this(BasicVehicleContainerHighFrequency.builder().create());
        }
    ...
    public static class BasicVehicleContainerHighFrequency {
        ...
        public static class Builder {
            ...
            public Builder vehicleLength(VehicleLength vehicleLength) {
                checkCreated();
                val.vehicleLength = vehicleLength;
                return this;
            }

            public Builder vehicleWidth(VehicleWidth vehicleWidth) {
                checkCreated();
                val.vehicleWidth = vehicleWidth;
                return this;
            }

            public Builder longitudinalAcceleration(LongitudinalAcceleration longitudinalAcceleration) {
                checkCreated();
                val.longitudinalAcceleration = longitudinalAcceleration;
                return this;
            }
            ...
            public Builder curvatureCalculationMode(CurvatureCalculationMode curvatureCalculationMode) {
                checkCreated();
                val.curvatureCalculationMode = curvatureCalculationMode;
                return this;
            }
            ...
            public Builder accelerationControl(AccelerationControl accelerationControl) {
                checkCreated();
                val.accelerationControl = accelerationControl;
                return this;
            }

            public Builder lanePosition(LanePosition lanePosition) {
                checkCreated();
            ...
            public Builder steeringWheelAngle(SteeringWheelAngle steeringWheelAngle) {
                checkCreated();
                val.steeringWheelAngle = steeringWheelAngle;
                return this;
            }

            public Builder lateralAcceleration(LateralAcceleration lateralAcceleration) {
                checkCreated();
                val.lateralAcceleration = lateralAcceleration;
                return this;
            }

            public Builder verticalAcceleration(VerticalAcceleration verticalAcceleration) {
                checkCreated();
                val.verticalAcceleration = verticalAcceleration;
                return this;
            }

            public Builder performanceClass(PerformanceClass performanceClass) {
                checkCreated();
            ...
            public Builder cenDsrcTollingZone(CenDsrcTollingZone cenDsrcTollingZone) {
                checkCreated();
                val.cenDsrcTollingZone = cenDsrcTollingZone;
                return this;
            }
        }
    }
    ...
    public static class Curvature {
        ...
        public Curvature() {
            this(new CurvatureValue(), CurvatureConfidence.unavailable);
        }
    ...
    public static class Altitude {
        ...
        public Altitude() {
            this(new AltitudeValue(), AltitudeConfidence.unavailable);
        }
    ...
    public static class SteeringWheelAngle {
        ...
        public SteeringWheelAngle() {
            this(new SteeringWheelAngleValue(),
    ...
    public static class VerticalAcceleration {
        ...
        public VerticalAcceleration() {
            this(new VerticalAccelerationValue(), new AccelerationConfidence());
        }
    ...
    public static class LowFrequencyContainer {
        ...
        public LowFrequencyContainer() {
            this(new BasicVehicleContainerLowFrequency());
        }
    ...
    public static class SafetyCarContainer {
        ...
        public SafetyCarContainer() {
            this(new LightBarSirenInUse());
        }

        public SafetyCarContainer(LightBarSirenInUse lightBarSirenInUse) {
            this(lightBarSirenInUse, null, null, null);
        }
    ...
    @Sequence
    public static class Denm extends Etsi {
        ItsPduHeader header;
        DecentralizedEnvironmentalNotificationMessage denm;

        public Denm() {
            this(new ItsPduHeader(new ItsPduHeader.MessageId(ItsPduHeader.MessageId.denm)), new DecentralizedEnvironmentalNotificationMessage());
        }
    ...
    public static class ManagementContainer {
        ...
        @Asn1Optional
        ValidityDuration validityDuration = defaultValidity;
        @Asn1Optional
        ...
        public static class Builder {
            ...
            public Builder detectionTime(TimestampIts detectionTime) {
                this.detectionTime = detectionTime;
                return this;
            }

            public Builder referenceTime(TimestampIts referenceTime) {
                this.referenceTime = referenceTime;
                return this;
            }
            ...
            public Builder relevanceDistance(RelevanceDistance relevanceDistance) {
                this.relevanceDistance = relevanceDistance;
                return this;
            }

            public Builder relevanceTrafficDirection(RelevanceTrafficDirection relevanceTrafficDirection) {
                this.relevanceTrafficDirection = relevanceTrafficDirection;
                return this;
            }

            public Builder validityDuration(ValidityDuration validityDuration) {
                this.validityDuration = validityDuration;
                return this;
            }

            public Builder transmissionInterval(TransmissionInterval transmissionInterval) {
                this.transmissionInterval = transmissionInterval;
                return this;
            }
    ...
    public static class DangerousGoodsExtended {
        ...
        @Asn1Optional
        EmergencyActionCode emergencyActionCode;
        @Asn1Optional
        ...
        public static class EmergencyActionCode extends Asn1String {
            public EmergencyActionCode() {
                this("");
            }

            public EmergencyActionCode(String value) {
                super(value);
            }
        }
