...
import it.almaviva.etsi_messages.CoopIts.ItsPduHeader.MessageId;
...
public class CoopIts {
    ...
    public static class Cam extends Etsi {
        ...
        public Cam() { this(new ItsPduHeader(new ItsPduHeader.MessageId(ItsPduHeader.MessageId.cam)), new CoopAwareness()); }
    ...
    public static class Denm extends Etsi {
        ...
        public Denm() { this (new ItsPduHeader(new ItsPduHeader.MessageId(ItsPduHeader.MessageId.denm)), new DecentralizedEnvironmentalNotificationMessage()); }
